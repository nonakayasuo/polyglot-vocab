  ...
  return (
    <div className="py-8">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-500">あなたの学習スタイルに合ったプランを選択</p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
        {plans.map((plan) => {
          const Icon = planIcons[plan.id as keyof typeof planIcons] || Zap;
          const gradientColor = planColors[plan.id as keyof typeof planColors] || planColors.free;
