...
const achievements = [
  ...
  // Phase 4: スラング・コミュニティ系（新規）
  {
    code: "slang_beginner",
    name: "Slang Novice",
    nameJa: "スラング入門",
    description: "Learn 10 slang words",
    descriptionJa: "10個のスラングを学習",
    icon: "🔥",
    category: "slang",
    requirement: 10,
    xpReward: 50,
  ...
  {
    code: "slang_intermediate",
    name: "Slang Speaker",
    nameJa: "スラングスピーカー",
    description: "Learn 50 slang words",
    descriptionJa: "50個のスラングを学習",
    icon: "💬",
    category: "slang",
    requirement: 50,
    xpReward: 200,
  ...
  },
  {
    ...
    name: "Slang Master",
    nameJa: "スラングマスター",
    description: "Learn 100 slang words",
    descriptionJa: "100個のスラングを学習",
    icon: "🗣️",
    category: "slang",
    requirement: 100,
    xpReward: 500,
  ...
  },
  {
    ...
    name: "Native Speaker",
    nameJa: "ネイティブスピーカー",
    description: "Learn 200 slang words",
    descriptionJa: "200個のスラングを学習",
    icon: "👑",
    category: "slang",
    requirement: 200,
    xpReward: 1500,
  ...
  {
    code: "slang_test_passed",
    name: "Slang Certified",
    nameJa: "スラング認定",
    description: "Pass the slang comprehension test",
    descriptionJa: "スラング理解度テストに合格",
    icon: "📜",
    category: "slang",
    requirement: 1,
    xpReward: 300,
  ...
  {
    code: "buzzword_collector",
    name: "Buzzword Collector",
    nameJa: "バズワードコレクター",
    description: "Learn 20 trending buzzwords",
    descriptionJa: "20個のバズワードを学習",
    icon: "📈",
    category: "slang",
    requirement: 20,
    xpReward: 150,
  ...
  {
    code: "community_first_comment",
    name: "Conversation Starter",
    nameJa: "会話のきっかけ",
    description: "Post your first comment",
    descriptionJa: "最初のコメントを投稿",
    icon: "💭",
    category: "community",
    requirement: 1,
    xpReward: 20,
  ...
  {
    code: "community_10_comments",
    name: "Active Participant",
    nameJa: "アクティブ参加者",
    description: "Post 10 comments",
    descriptionJa: "10個のコメントを投稿",
    icon: "🗨️",
    category: "community",
    requirement: 10,
    xpReward: 100,
  ...
  {
    code: "slang_contributor",
    name: "Slang Contributor",
    nameJa: "スラング貢献者",
    description: "Submit 5 slang entries to the dictionary",
    descriptionJa: "スラング辞書に5個投稿",
    icon: "✏️",
    category: "community",
    requirement: 5,
    xpReward: 200,
  ...
  },
  {
    ...
    name: "Group Founder",
    nameJa: "グループ創設者",
    description: "Create a learning group",
    descriptionJa: "学習グループを作成",
    icon: "👥",
    category: "community",
    requirement: 1,
    xpReward: 100,
  ...
  {
    code: "register_master",
    name: "Register Master",
    nameJa: "レジスターマスター",
    description: "Learn words in all register levels",
    descriptionJa: "全レジスターレベルの単語を学習",
    icon: "🎭",
    category: "special",
    requirement: 5,
    xpReward: 300,
